...
if(isset($_GET['search'])){
    ...
    $sql = "SELECT blooddinfo.*, users.* from blooddinfo, users where blooddinfo.rid=users.id && bg='$searchKey'";
}else{
    $sql = "SELECT blooddinfo.*, users.* from blooddinfo, users where blooddinfo.rid=users.id";
}
